...
dixperPluginSample.onPixiLoad = () => {
  setTimeout(() => {
    if (DX_CONTEXT.language === "es") {
      ...
      evidencesList = [
        {
          evidence: "Temperaturas heladas",
          evidence_id: 1,
          ghosts: [2, 5, 6, 8, 11, 12, 16, 17, 20, 21, 24],
        },
        {
          evidence: "Orbes espectrales",
          evidence_id: 2,
        ...
        {
          evidence: "Proyector D.O.T.S.",
          evidence_id: 4,
          ghosts: [1, 3, 4, 11, 13, 15, 19, 22, 23, 24],
        },
        {
          evidence: "Medidor EMF 5",
          evidence_id: 5,
          ghosts: [4, 6, 9, 10, 11, 15, 17, 18, 21, 22],
        },
        {
          evidence: "Huellas dactilares",
          evidence_id: 6,
          ghosts: [1, 2, 4, 5, 6, 9, 10, 13, 14, 20],
        },
        {
          evidence: "Escritura fantasma",
          evidence_id: 7,
