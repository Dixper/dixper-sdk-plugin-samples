...
const createBall = () => {
    ball = new PIXI.Sprite.from("https://raw.githubusercontent.com/Dixper/dixper-sdk-plugin-samples/origin/halloween-rii/src/halloween/assets/images/Target_INOUT_00017.png");
...
const hideBall = () => {
    ...
    gsap.fromTo(
        ...
        { x: table[0].instance.x, y: table[0].instance.y + 100, duration: 3, onComplete: onComplete }
    );
...
const revealCube = (cubeRevealed) => {
    ...
    gsap.fromTo(
        ...
        { x: cubeRevealed.instance.x, y: cubeRevealed.instance.y - 60, duration: 2, onComplete: onComplete }
    );
